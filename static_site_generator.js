...
(async () => {
  try {
    ...
    // Navigate to the Static Site Generators category page
    const url = 'https://www.producthunt.com/categories/static-site-generators';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/static-site-generators"]');
    ...
    fs.writeFileSync('static_site_generators.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to static_site_generators.json');
