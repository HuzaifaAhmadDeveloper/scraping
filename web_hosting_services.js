...
(async () => {
  try {
    ...
    // Navigate to the Web Hosting category page
    const url = 'https://www.producthunt.com/categories/web-hosting';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/web-hosting"]');
    ...
    fs.writeFileSync('web_hosting_services.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to web_hosting_services.json');
