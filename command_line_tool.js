...
(async () => {
  try {
    ...
    // Navigate to the Command Line Tools category page
    const url = 'https://www.producthunt.com/categories/command-line-tools';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/command-line-tools"]');
    ...
    fs.writeFileSync('command_line_tool.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to command_line_tool.json');
