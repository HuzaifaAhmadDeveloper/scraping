...
(async () => {
  try {
    ...
    // Navigate to the Code Editors category page
    const url = 'https://www.producthunt.com/categories/code-editors';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/code-editors"]');
    ...
    fs.writeFileSync('code_editors.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to code_editors.json');
