...
(async () => {
  try {
    ...
    // Navigate to the Cloud Computing Platforms category page
    const url = 'https://www.producthunt.com/categories/cloud-computing-platforms';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/cloud-computing-platforms"]');
    ...
    fs.writeFileSync('cloud_computing_platform.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to cloud_computing_platform.json');
