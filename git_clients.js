...
(async () => {
  try {
    ...
    // Navigate to the Git Clients category page
    const url = 'https://www.producthunt.com/categories/git-clients';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/git-clients"]');
    ...
    fs.writeFileSync('git_clients.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to git_clients.json');
