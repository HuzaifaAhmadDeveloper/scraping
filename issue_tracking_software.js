...
(async () => {
  try {
    ...
    // Navigate to the Issue Tracking Software category page
    const url = 'https://www.producthunt.com/categories/issue-tracking-software';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/issue-tracking-software"]');
    ...
    fs.writeFileSync('issue_tracking_software.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to issue_tracking_software.json');
