...
(async () => {
  try {
    ...
    // Navigate to the AI Coding category page
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/ai-coding"]');
    ...
    fs.writeFileSync('ai_coding.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to ai_coding.json');
