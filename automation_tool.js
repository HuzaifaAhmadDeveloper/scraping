...
(async () => {
  try {
    ...
    // Navigate to the Automation category page
    const url = 'https://www.producthunt.com/categories/automation';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/automation"]');
    ...
    fs.writeFileSync('automation_tool.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to automation_tool.json');
