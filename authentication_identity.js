...
(async () => {
  try {
    ...
    // Navigate to the Authentication & Identity category page
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/authentication-identity"]');
    ...
    fs.writeFileSync('authentication_identity.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to authentication_identity.json');
