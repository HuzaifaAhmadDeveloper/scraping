...
(async () => {
  try {
    ...
    // Navigate to the No Code Platforms category page
    const url = 'https://www.producthunt.com/categories/no-code-platforms';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/no-code-platforms"]');
    ...
    fs.writeFileSync('no_code_platforms.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to no_code_platforms.json');
