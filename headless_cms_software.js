...
(async () => {
  try {
    ...
    // Navigate to the Headless CMS category page
    ...
    fs.writeFileSync('headless_cms_software.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to headless_cms_software.json');
