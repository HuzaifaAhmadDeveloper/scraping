...
const urls = [
  'https://www.producthunt.com/categories/shopping-1'
];
...
(async () => {
  ...
  fs.writeFileSync('lifestyleproducts.json', JSON.stringify(scrapedData, null, 2));

  console.log('Data saved to lifestyleproducts.json');
