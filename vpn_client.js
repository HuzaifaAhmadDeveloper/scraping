...
(async () => {
  try {
    ...
    // Navigate to the VPN Client category page
    const url = 'https://www.producthunt.com/categories/vpn-client';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/vpn-client"]');
    ...
    fs.writeFileSync('vpn_client.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to vpn_client.json');
