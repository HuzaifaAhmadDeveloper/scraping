...
(async () => {
  try {
    ...
    // Navigate to the Security & Compliance category page
    const url = 'https://www.producthunt.com/categories/security-compliance';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/security-compliance"]');
    ...
    fs.writeFileSync('security_and_compliance.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to security_and_compliance.json');
