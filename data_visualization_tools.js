...
(async () => {
  try {
    ...
    // Navigate to the Data Visualization category page
    const url = 'https://www.producthunt.com/categories/data-visualization';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/data-visualization"]');
    ...
    fs.writeFileSync('data_visualization_tools.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to data_visualization_tools.json');
