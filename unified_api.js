...
(async () => {
  try {
    ...
    // Navigate to the Unified API category page
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/unified-api"]');
    ...
    fs.writeFileSync('unified_api.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to unified_api.json');
