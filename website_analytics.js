...
(async () => {
  try {
    ...
    // Navigate to the Website Analytics category page
    const url = 'https://www.producthunt.com/categories/website-analytics';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/website-analytics"]');
    ...
    fs.writeFileSync('website_analytics.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to website_analytics.json');
