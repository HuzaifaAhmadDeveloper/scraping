...
(async () => {
  try {
    ...
    // Navigate to the Code Review Tools category page
    const url = 'https://www.producthunt.com/categories/code-review-tools';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/code-review-tools"]');
    ...
    fs.writeFileSync('code_review_tool.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to code_review_tool.json');
