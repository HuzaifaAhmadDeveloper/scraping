...
(async () => {
  try {
    ...
    // Navigate to the Video Hosting category page
    const url = 'https://www.producthunt.com/categories/video-hosting';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/video-hosting"]');
    ...
    fs.writeFileSync('video_hosting.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to video_hosting.json');
