...
(async () => {
  try {
    ...
    // Navigate to the Membership category page
    const url = 'https://www.producthunt.com/categories/membership';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/membership"]');
    ...
    fs.writeFileSync('membership_software.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to membership_software.json');
