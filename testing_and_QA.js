...
(async () => {
  try {
    ...
    // Navigate to the Testing & QA category page
    const url = 'https://www.producthunt.com/categories/testing-and-qa';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/testing-and-qa"]');
    ...
    fs.writeFileSync('testing_and_QA.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to testing_and_QA.json');
