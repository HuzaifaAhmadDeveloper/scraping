...
(async () => {
  try {
    ...
    // Navigate to the Standup Bots category page
    const url = 'https://www.producthunt.com/categories/standup-bots';
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      const headingElement = document.querySelector('a[href="/categories/standup-bots"]');
    ...
    fs.writeFileSync('standup_bots.json', JSON.stringify(scrapedData, null, 2));

    console.log('Data saved to standup_bots.json');
